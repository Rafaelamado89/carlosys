    ...
    <div className="p-4 lg:p-8 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Visão geral da oficina</p>
        </div>
        <Link
          to="/work-orders/new"
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="bg-card border rounded-xl overflow-hidden">
          <div className="px-5 py-4 border-b flex items-center justify-between">
            ...
            <Link to="/invoices" className="text-sm text-primary hover:underline">Ver todos</Link>
          </div>
          <div className="divide-y">
            {invoices.length === 0 && (
              <div className="p-8 text-center text-muted-foreground text-sm">Sem orçamentos registados.</div>
            )}
            {invoices.map((inv) => (
              <Link
                key={inv.id}
